...
export default function AbsenceAnalyticsBoard({ scope }: AbsenceAnalyticsBoardProps) {
  ...
  useEffect(() => {
    ...
    ]).then(([d, g]) => { setDashboard(d); setGrid(g); })
  ...
  return (
    <div className="space-y-10">
      ...
      <section className="space-y-4">
        ...
        {loadingMonth ? <LoadingBlock /> : (dashboard && grid && <CeMoisPanel dashboard={dashboard} grid={grid} onSelectEmployee={setSelectedEmployeeId} />)}
      </section>
