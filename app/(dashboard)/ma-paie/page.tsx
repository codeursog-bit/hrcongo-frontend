...
import { FileText, Download, Calendar, Loader2, ArrowLeft, Eye, Clock, X, Printer } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchMyPayrolls = async () => {
      try {
        ...
        if (e.message?.includes('accès')) alert("Vous n'avez pas accès aux bulletins de paie");
      } finally {
        setIsLoading(false);
      }
    };
  ...
  return (
    <div className="max-w-[1200px] mx-auto pb-20 space-y-8">
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm">
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{formatMoney(yearTotal)} F</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {payrolls
              ...
              .map((payroll) => (
                ...
                >
                  <div className="absolute top-0 right-0 w-24 h-24 bg-sky-50 dark:bg-sky-900/10 rounded-bl-full -mr-6 -mt-6 transition-transform group-hover:scale-150" />
                  <div className="relative z-10">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                      ...
                      <button
                        onClick={(e) => { e.stopPropagation(); setViewingPayroll(payroll); }}
          ...
          <div className="bg-gradient-to-br from-sky-50 to-emerald-50 dark:from-sky-900/20 dark:to-emerald-900/20 rounded-2xl p-6 border border-sky-200 dark:border-sky-800">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-gray-900 dark:text-white mb-2">💡 Informations importantes</h3>
      ...
      {viewingPayroll && (
        ...
        >
          <div
            style={{ background:'#fff', borderRadius:16, maxWidth:860, width:'100%', overflow:'hidden', position:'relative', alignSelf:'flex-start' }}
          ...
          >
            ...
            <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', padding:'12px 16px', borderBottom:'1px solid #e2e8f0', background:'#f8fafc', flexShrink:0 }}>
              <span style={{ fontSize:13, fontWeight:700, color:'#0f172a' }}>
                Bulletin — {new Date(0, viewingPayroll.month - 1).toLocaleString('fr-FR', { month: 'long' })} {viewingPayroll.year}
              </span>
            ...
            {/* Bulletin avec le template personnalisé de l'entreprise */}
            <BulletinRenderer payroll={viewingPayroll} template={template} />
          </div>
        </div>
      )}
    </div>
