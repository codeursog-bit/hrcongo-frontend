  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-4">
        ...
        {totalOvertime > 0 && (
          <span className="text-xs font-bold bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 px-3 py-1 rounded-full">
      ...
      {hasOvertime && (
        <div className="mb-4 p-3 bg-amber-100 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div>
          ...
          <input
            ...
            className="w-full p-3 border border-amber-200 dark:border-amber-800 rounded-xl bg-[var(--surface)] font-mono text-lg focus:outline-none focus:ring-2 focus:ring-amber-500/20"
          />
          <p className="text-xs text-[var(--text-muted)] mt-1">Ex: 5h = 5, 30min = 0.5</p>
        </div>
        <div>
          <label className="block text-sm mb-1 font-medium text-amber-700 dark:text-amber-300">
          ...
          <input
            ...
            className="w-full p-3 border border-amber-200 dark:border-amber-800 rounded-xl bg-[var(--surface)] font-mono text-lg focus:outline-none focus:ring-2 focus:ring-amber-500/20"
          />
          <p className="text-xs text-[var(--text-muted)] mt-1">Ex: 2h = 2, 45min = 0.75</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-3 border border-amber-200 dark:border-amber-800 rounded-xl bg-[var(--surface)] font-mono text-lg focus:outline-none focus:ring-2 focus:ring-amber-500/20"
            />
            <p className="text-xs text-[var(--text-muted)] mt-1">Ex: 3h = 3, 30min = 0.5</p>
          </div>
        </div>
      </div>
