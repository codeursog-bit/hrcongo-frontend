...
export default function WeeklyView({ userRole, userDepartment, date, canRecordAttendanceForAll = false }: WeeklyViewProps) {
  ...
  const departmentStats = useMemo(() => {
    ...
    employeeMap.forEach(({ employee: emp, statusByDate }) => {
      ...
      if (userRole === 'MANAGER' && userDepartment && !canRecordAttendanceForAll && deptName !== userDepartment) return;
  ...
  }, [employeeMap, userRole, userDepartment, weekDays, canRecordAttendanceForAll]);
