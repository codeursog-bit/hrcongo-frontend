...
import {
  ...
  HelpCircle, MapPin, History, LogOut, Info,
} from 'lucide-react';
            ...
            <motion.div key={selected.id} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 overflow-hidden">
              ...
              <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  {selected.actualReturnTime && (
                    <div className="flex items-center gap-2 text-sm px-3.5 py-2.5 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-300">
                      <LogOut size={14} /> Retour effectué à {new Date(selected.actualReturnTime).toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit' })}
                    </div>
                  )}
                ...
                {/* Aperçu du ticket */}
                <div className="bg-gray-100 dark:bg-gray-900 rounded-2xl p-4 overflow-auto flex justify-center border border-gray-200 dark:border-gray-700">
