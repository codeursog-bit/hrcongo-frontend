// // ============================================================================
// // 💎 PAGE PRICING - TARIFICATION AVEC ESSAI GRATUIT 30 JOURS
// // ============================================================================
...
//   const canceled = searchParams.get('canceled'); // ✅ Détecte si annulé
...
//       const response = await api.post('/subscriptions/upgrade', { // ✅ CORRIGÉ
//         plan,
//         billingPeriod,
//       });

//       // ✅ REDIRIGER VERS YABETOOPAY
//       console.log('🔗 Redirecting to:', response.data.checkoutUrl);
//       window.location.href = response.data.checkoutUrl;

//     } catch (error: any) {
//       console.error('❌ Upgrade error:', error);
//       toast.error(error.response?.data?.message || 'Erreur lors de l\'upgrade');
//       setUpgrading(false);
//     }
//   };
