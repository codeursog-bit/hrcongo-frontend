          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-5 shadow-sm">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm"><span className="text-gray-500">Retraite salarié (4%)</span><span className="font-bold">{Math.round(cnssTotal.cnssSalarial).toLocaleString('fr-FR')} FCFA</span></div>
                <div className="flex justify-between text-sm border-t border-gray-100 dark:border-gray-700 pt-2"><span className="font-bold text-gray-700 dark:text-gray-300">Total salarié</span><span className="font-black text-sky-600">{Math.round(cnssTotal.cnssSalarial).toLocaleString('fr-FR')} FCFA</span></div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-5 shadow-sm">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex justify-between text-sm border-t border-gray-100 dark:border-gray-700 pt-2"><span className="font-bold text-gray-700 dark:text-gray-300">Total patronal</span><span className="font-black text-violet-600">{Math.round(cnssTotal.cnssEmployeurTotal).toLocaleString('fr-FR')} FCFA</span></div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-5 shadow-sm">
              ...
              <div className="space-y-1.5">
                ...
                <div className="border-t border-gray-100 dark:border-gray-700 pt-2 space-y-1">
                  <div className="flex justify-between text-sm"><span className="text-gray-500">Total CNSS global</span><span className="font-bold">{Math.round(cnssTotal.totalCotisations).toLocaleString('fr-FR')} FCFA</span></div>
