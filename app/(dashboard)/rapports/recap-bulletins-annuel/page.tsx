      ...
      {loading ? (
        ...
        <>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700/60 p-5 mb-4 shadow-sm print:shadow-none print:border-black">
            <p className="font-semibold text-slate-900 dark:text-white">{declaration.companyName}</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-4 print:hidden">
            <div className="flex items-center justify-between p-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700/60 shadow-sm">
              <div>
                <p className="text-xs text-slate-500 dark:text-slate-400">Employés inclus</p>
                <p className="text-lg font-bold text-slate-900 dark:text-white">{bulletins.length}</p>
                <p className="text-[11px] text-slate-400">CDD / CDI uniquement</p>
              </div>
              <Users className="w-5 h-5 text-blue-500" />
            </div>
            <div className="flex items-center justify-between p-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700/60 shadow-sm">
              <div>
                <p className="text-xs text-slate-500 dark:text-slate-400">Masse salariale (espèces)</p>
                <p className="text-lg font-bold text-slate-900 dark:text-white">{fmt(totalMontantEspeces)} F</p>
              </div>
              <Wallet className="w-5 h-5 text-emerald-500" />
            </div>
            <div className="flex items-center justify-between p-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700/60 shadow-sm">
              <div>
                <p className="text-xs text-slate-500 dark:text-slate-400">IRPP retenu cumulé</p>
                <p className="text-lg font-bold text-slate-900 dark:text-white">{fmt(totalIrpp)} F</p>
              </div>
              <Landmark className="w-5 h-5 text-red-500" />
            </div>
            <div className="flex items-center justify-between p-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700/60 shadow-sm">
              <div>
                <p className="text-xs text-slate-500 dark:text-slate-400">Indemnités non imposables</p>
                <p className="text-lg font-bold text-slate-900 dark:text-white">{fmt(totalIndemnites)} F</p>
              </div>
          ...
          <div className="relative mb-4 print:hidden">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-sm text-slate-700 dark:text-white placeholder:text-slate-400 outline-none focus:ring-2 focus:ring-blue-500/40"
            />
          </div>
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                  {filteredBulletins.map((b) => (
                    <tr key={b.employeeId} className="hover:bg-slate-50 dark:hover:bg-slate-800/40">
                      <td className="px-4 py-3 text-slate-500 dark:text-slate-400">{b.ordre}</td>
                      ...
                      <td className="px-4 py-3 text-slate-600 dark:text-slate-300">{b.position}</td>
          ...
          <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700/60 overflow-hidden">
            ...
            <div className="p-5 space-y-3">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
                ...
                <strong className="text-slate-800 dark:text-white">avantages en nature</strong>{' '}
                (logement, autres — jamais suivis automatiquement) et les{' '}
                <strong className="text-slate-800 dark:text-white">informations personnelles</strong>{' '}
