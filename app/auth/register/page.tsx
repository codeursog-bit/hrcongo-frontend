              ...
              return (
                <div key={s} className="flex flex-col items-center gap-2">
                  <motion.div 
                    ...
                    `}
                  >
                    {isCompleted ? <Check size={18} strokeWidth={3} /> : s === 1 ? <Building2 size={18} /> : s === 2 ? <User size={18} /> : <Sparkles size={18} />}
                  </motion.div>
                  <span className={`text-xs font-bold tracking-wider ${isActive ? 'text-cyan-400' : isCompleted ? 'text-emerald-400' : 'text-gray-500'}`}>
                    {s === 1 ? 'ENTREPRISE' : s === 2 ? 'COMPTE' : 'SUCCÈS'}
                  </span>
                </div>
              );
            })}
                ...
                <form onSubmit={form1.handleSubmit(onStep1Submit)} className="space-y-5">
                  <div className="space-y-4">
                    <div className="relative group">
                      ...
                      />
                      {form1.formState.errors.companyName && <p className="text-xs text-red-400 mt-1 ml-1">{form1.formState.errors.companyName.message}</p>}
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="relative group">
                            ...
                            <select {...form1.register('city')} className="block w-full pl-12 pr-4 py-3.5 bg-black/20 border border-white/10 rounded-xl text-white focus:ring-1 focus:ring-cyan-500/50 focus:border-cyan-500/50 outline-none appearance-none cursor-pointer">
                            ...
                            {form1.formState.errors.city && <p className="text-xs text-red-400 mt-1 ml-1">{form1.formState.errors.city.message}</p>}
                        </div>
                        <div className="relative group">
                            ...
                            <select {...form1.register('sector')} className="block w-full pl-12 pr-4 py-3.5 bg-black/20 border border-white/10 rounded-xl text-white focus:ring-1 focus:ring-cyan-500/50 focus:border-cyan-500/50 outline-none appearance-none cursor-pointer">
                            ...
                            {form1.formState.errors.sector && <p className="text-xs text-red-400 mt-1 ml-1">{form1.formState.errors.sector.message}</p>}
                        </div>
                    </div>
                    ...
                    <div className="relative group">
                      ...
                      />
                      {form1.formState.errors.phone && <p className="text-xs text-red-400 mt-1 ml-1">{form1.formState.errors.phone.message}</p>}
                    </div>
                    ...
                    <div className="relative group">
                      ...
                      />
                      {form1.formState.errors.address && <p className="text-xs text-red-400 mt-1 ml-1">{form1.formState.errors.address.message}</p>}
                    </div>
              ...
              >
                ...
                <form onSubmit={form2.handleSubmit(onStep2Submit)} className="space-y-5">
                  ...
                  <div className="relative group">
                    ...
                    />
                    {form2.formState.errors.email && <p className="text-xs text-red-400 mt-1 ml-1">{form2.formState.errors.email.message}</p>}
                  </div>
                  ...
                  />
                  {form2.formState.errors.confirmPassword && <p className="text-xs text-red-400 mt-1 ml-1">{form2.formState.errors.confirmPassword.message}</p>}
                  ...
                  <div className="pt-4 flex gap-3">
                    ...
                    >
                      {isLoading ? <Loader2 className="animate-spin" size={20} /> : <>Créer Compte <Check size={18} /></>}
                    </button>
                  </div>
                </form>
              </motion.div>
