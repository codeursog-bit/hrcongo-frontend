...
const CONTACT_INFO = [
  { icon: Mail,    label: 'Email',         value: 'rhkonza@gmail.com',       href: 'mailto:rhkonza@gmail.com', color: 'text-emerald-400',   bg: 'bg-emerald-500/10'   },
  { icon: Phone,   label: 'Téléphone',     value: '+242 06 413 36 93',           href: 'tel:+242064133693',          color: 'text-emerald-400',bg: 'bg-emerald-500/10'},
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 border border-emerald-500/20 rounded-xl">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                ...
                Urgences : <a href="tel:+242064133693" className="text-emerald-400 no-underline hover:underline font-bold">+242 06 413 36 93</a>
              </p>
            </div>
