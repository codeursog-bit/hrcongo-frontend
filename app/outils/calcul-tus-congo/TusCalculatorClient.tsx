    ...
    <div className="min-h-screen bg-[#050607]">
      ...
      <div className="max-w-4xl mx-auto px-4 py-10 space-y-10">
        ...
        <section className="rounded-2xl border p-6 bg-gray-800 border-gray-700">
          <h2 className="font-black text-lg mb-3 text-white">🏦 Le TUS en 3 phrases simples</h2>
          <div className="space-y-3">
            {[
              ...
              <div key={s.n} className="flex items-start gap-4 p-4 rounded-xl border bg-amber-900/20 border-amber-900">
                ...
                <div>
                  <p className="font-bold text-sm text-amber-300">{s.t}</p>
        ...
        <div className="grid md:grid-cols-2 gap-6 items-start">
          <div className="rounded-2xl border p-6 bg-gray-800 border-gray-700">
            <h2 className="font-black text-base mb-2 text-white">Calculez le TUS</h2>
            ...
            <input type="number" value={gross} onChange={e => setGross(e.target.value)} placeholder="Ex : 500 000"
              className="w-full px-4 py-3 border-2 rounded-xl text-lg font-black font-mono outline-none focus:border-amber-400 transition-colors border-gray-600 bg-gray-700" />
          ...
          {!res ? (
            ...
            <div className="space-y-4">
              <div className="rounded-2xl border overflow-hidden bg-gray-800 border-amber-800">
                <div className="px-4 py-3 border-b bg-amber-900/20 border-amber-900">
                  <p className="text-[10px] font-bold uppercase tracking-wider text-amber-300">TUS sur {fmt(res.g)} FCFA</p>
                  <p className="text-[10px] text-gray-400">100% charge employeur</p>
                </div>
                <div className="p-4 space-y-3">
                  <div className="flex justify-between items-center py-2 border-b border-gray-700">
                    <div>
                      <p className="text-sm font-bold text-gray-200">🏛️ Part DGI (2,025%)</p>
                  ...
                  <div className="flex justify-between items-center py-2">
                    <div>
                      <p className="text-sm font-bold text-gray-200">🏥 Part CNSS (5,475%)</p>
                  ...
                  <div className="flex justify-between items-center pt-2 border-t -mx-4 px-4 py-3 border-amber-800 bg-amber-900/20">
                    <span className="text-sm font-bold text-amber-300">Total TUS mensuel</span>
                    <span className="font-black font-mono text-lg text-amber-300">{fmt(res.total)} FCFA</span>
                  </div>
                </div>
              </div>
              <Link href="/simulateur"
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">TUS + CNSS + CAMU tout inclus</p>
                </div>
        ...
        {/* FAQ */}
        <section>
          <h2 className="text-xl font-black mb-4 text-white">Questions fréquentes — TUS Congo</h2>
          <div className="space-y-3">
            {[
