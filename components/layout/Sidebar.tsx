...
const navItems: NavItem[] = [
  ...
  {
    id: 'employes',
    label: 'Gestion Employés',          // renommé (était "Dossiers Employés")
    icon: Users,
    path: '/employes',
  ...
  // ─── Pointage Admin / RH ─────────────────────────────────────────────────────
  // Saisie manuelle uniquement (le RH se pointe via bouton intégré dans cette page)
  {
  ...
  {
    id: 'mon_equipe',
    label: 'Mon Équipe',                // remplace "Dossiers Employés" pour MANAGER
    icon: Users2,
    path: '/employes',                  // même route, filtrée côté serveur par département
  ...
  // Présences de l'équipe (lecture / supervision)
  {
    id: 'presences_equipe',
  ...
  // Pointage manuel du département (corriger/ajouter des pointages pour son équipe)
  {
    id: 'pointage_manuel_manager',
    label: 'Pointage Équipe',           // saisie manuelle pour le département
    icon: ClipboardEdit,
    path: '/presences/pointage-manuel',
    allowedRoles: ['MANAGER'],
  },
  // Se pointer soi-même via GPS
  {
  ...
  // Demandes de congés — Employé uniquement (+ Manager ci-dessus)
  {
    id: 'mes_conges',
    label: 'Mes Demandes',
    icon: FolderHeart,
