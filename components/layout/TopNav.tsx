        ...
        <div className="hidden md:flex flex-1 max-w-md mx-8">
          <div className="relative w-full group">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <Search size={16} className="text-slate-400 group-focus-within:text-sky-500" />
            </div>
            <input
              type="text"
              className="block w-full pl-10 pr-12 py-2.5 border border-slate-200 dark:border-white/10 rounded-xl bg-slate-50/50 dark:bg-black/20 text-slate-900 dark:text-slate-200 focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500/50 text-sm transition-all"
