...
//   ABS_CONGE, ABS_DEDUCT, CTAX_*
//
//   LOAN, ADVANCE, MANUAL_DEDUCTION          → retenueItems (avances, prêts, retenues libres)
//
// EMPLOYER_COST
//   CNSS_EMP                                 → empItems (charges patronales)
//   TUS_DGI, TUS_CNSS                        → empItems
...
/** Codes DEDUCTION qui sont des retenues diverses (prêts, avances, retenues libres…) */
const RETENUE_CODES = new Set(['LOAN', 'ADVANCE', 'MANUAL_DEDUCTION']);
